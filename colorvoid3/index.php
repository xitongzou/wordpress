...
<?php echo "$ABSPATH";?>
		...
		<?php endwhile; ?>
				...
				<div class="pagenavigation">
					<div class="pagenav">
						<div class="left"><?php if(next_posts_link('<p class="older">'.__('Older Entries',"glass").' </p>')) : ?><?php endif ; ?></div>
						<div class="right"><?php if(previous_posts_link('<p class="newer">'.__('Newer Entries',"glass").' </p>')) : ?><?php endif ; ?></div>
                        <div class="clearer">&nbsp;</div>
					</div>
